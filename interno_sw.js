...
const CACHE_NAME = "interno-savian-apps-shell-v2";
...
const SHELL_FILES = [
  ...
  "./interno_assets/interno_tickets-card.png",
  "./interno_assets/interno_jornada-card.png",
  "./interno_assets/interno_saviandm-card.png"
];
